...
//$2y$12$NtkJdK.h29/F05ng2LhENene/YJ23pPBRNWZShESdFQ0PvBhHCVyO
    ...
    Route::post('/delete-my-music', [ClientControllers::class, 'deleteMyMusic']);
    Route::post('/commentmusic/{name}', [ClientControllers::class, 'commentmusic']);
    ...
    // checkout pay
    Route::post('stripe', [ClientControllers::class, 'stripe'])->name('stripe');
    Route::get('success', [ClientControllers::class, 'success'])->name('success');
    Route::get('cancel', [ClientControllers::class, 'cancel'])->name('cancel');