...
<div class="bodyhome">
    <div class="header-search">
        <div class="left-header-search">
            <div class="noidung">Kết quả tìm kiếm {{ $tentl }}</div>
        </div>
                                    ...
                                    <div class="option">
                                        ...
                                        <div class="menu-right-media ">
                                            ...
                                            <div class="nhaccho" data-cho="{{ $nhactop10->maNhac }}"
                                                data-gia="{{ $nhactop10->gia }}"><i class="bi bi-phone-vibrate"></i>Cài
                                                nhạc
                                                chờ
                                            </div>
        ...
        <div class="contener">
            ...
            <div class="list-menu-contenter_ns">
                @foreach ($nghesi as $nstop20)
                    ...
                    @endphp
                    @foreach ($albumsearch as $albsear)
                        @if ($nstop20->id == $albsear->nghesi_idalbum)
                            @if ($dem == 0)
                                @php
                                    $dem++;
                                @endphp
                                <div class="body-Contener-search ">
                                    @foreach ($user as $item)
                                        @if ($item->id == $nstop20->id_nghesi_user)
                                            <img class="img-ns" src="../../images/{{ $item->image }}"
                                                alt="">
                                        @endif
                                    @endforeach
