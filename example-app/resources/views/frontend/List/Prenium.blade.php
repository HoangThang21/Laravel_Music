...
<div class="bodyhome">
    <div class="header-search">
        <div class="left-header-search">
            <div class="noidung">Nhạc Prenium</div>
        </div>
        ...
        <div class="contener">
            ...
            <div class="list-menu-contenter">
                @php
                    $isnhac = -1;
                @endphp
                @foreach ($nhac as $itemnhac)
                    @if ($itemnhac->vip == 1)
                        @foreach ($Chill as $itemalbum)
                            @if ($itemnhac->album_idnhac == $itemalbum->id)
                                @if ($isnhac != $itemalbum->id)
                                    <div class="body-Contener">
                                        <div class="item-body-content" data-album="{{ $itemalbum->id }}">
                                            <img src="../../images/{{ $itemalbum->hinhalbum }}" alt="">
                                            <div class="hover-item-body-content">
                                                <i class="bi bi-caret-right-fill"></i>
                                            </div>
                                        </div>
                                        <div class="title-body-content">{{ $itemalbum->tenalbum }}</div>
                                    </div>
                                    @php
                                        $isnhac = $itemalbum->id;
                                    @endphp
