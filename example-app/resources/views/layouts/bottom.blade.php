...
<div class="form-login-regis">
    <form class="form_container_register " action="#" method="post">
        @csrf
        ...
        <div class="title_container">
            ...
            <span class="subtitle">Chào mừng bạn đến với MoBiSong, đăng nhập để trải nghiệm tốt</span>
        </div>
        <div class="input_container">
            <label class="input_label" for="email_field">Họ tên</label>
            ...
            <input placeholder="Họ tên" title="Họ tên" name="input-name" type="text" class="input_field"
                id="email_field">
        </div>

        <div class="input_container">
            <label class="input_label" for="email_field">Email hoặc Số điện thoại</label>
        ...
        <div class="input_container">
            ...
            <input placeholder="Mật khẩu" title="Nhập mật khẩu" name="input-password" type="password"
        ...
        <div class="input_container">
            ...
            <input placeholder="Xác nhận Mật khẩu" title="Nhập mật khẩu để xác nhận" name="input-password"
                type="password" class="input_field" id="password_field">
        </div>
        <div class="input_container">
            <label class="input_label" for="password_field">Khi bạn đăng ký bạn đã đồng ý mọi giao dịch mua bán theo
                <a href="">điều kiện sử dụng và chính sách của MobiSong</a></label>
        </div>
        <button title="Đăng ký" type="submit" class="sign-in_btn">
            <span>Đăng ký</span>
        </button>
    </form>
